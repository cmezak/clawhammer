...
{
    [[CMCTweakManager sharedManager] prersentTweakInterfaceWithPresentingViewController:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel registerforTweakWithName:@"labelFont" forKeyPath:@"font"];
    return cell;
}
